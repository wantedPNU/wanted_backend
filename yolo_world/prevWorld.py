...
classes = [translate_to_eng("파란 옷을 입은 남자")]
print(classes)
...
# 프레임 별로 inference
def process_and_annotate_image(cnt, source_image_path, model, classes, bounding_box_annotator, label_annotator, confidence_threshold=0.1):
